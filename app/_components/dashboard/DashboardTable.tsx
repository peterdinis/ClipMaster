...
import { DataTableProps } from "@/app/_types/videoTypes";
...
import { Ghost, ChevronLeftIcon, ChevronRightIcon } from "lucide-react";
					...
					<TableBody>
						{table.getRowModel().rows.length ? (
							...
							<TableRow>
								...
								>
									<Ghost className="h-8 w-8 mx-auto animate-bounce" />
									 No videos uploaded
								</TableCell>
							</TableRow>
						)}
